...
public class Credito {
    ...
    public String calcularFechas() {
        ...
        LocalDate primerPago = ahora.plusMonths(3).withDayOfMonth(ahora.getDayOfMonth());
        LocalDate segundoPago = ahora.plusMonths(6).withDayOfMonth(ahora.getDayOfMonth());
        LocalDate tercerPago = ahora.plusMonths(9).withDayOfMonth(ahora.getDayOfMonth());
        LocalDate cuartoPago = ahora.plusMonths(12).withDayOfMonth(ahora.getDayOfMonth());
